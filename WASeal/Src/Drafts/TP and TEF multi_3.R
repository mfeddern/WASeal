...
herringtp <- (((herring['Glu']-herring['Phe'])-Beta.JN$GLU[1])/TEF['Glu'])+1
...
TP.GLU <- ((data$GLU.mean-data$PHE.mean-Beta.JN$GLU[1])/TEF['Glu'])+1
...
write.csv(total2, 'Data/Compiled/HierarchicalData_3.csv')
