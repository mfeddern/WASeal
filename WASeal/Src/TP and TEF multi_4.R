...
herringtp <- (((herring['Glu']-herring['Phe'])-Beta.JN$GLU[1]-TEF.JN$GLU[1])/TEF['Glu'])+2
herringtp.VAL <- (((herring['Val']-herring['Phe'])-Beta.JN$VAL [1]-TEF.JN$VAL[1])/TEF['Val'])+2
herringtp.Pro <- (((herring['Pro']-herring['Phe'])-Beta.JN$PRO [1]-TEF.JN$PRO[1])/TEF['Pro'])+2
herringtp.Asp <- (((herring['Asp']-herring['Phe'])-Beta.JN$ASP [1]-TEF.JN$ASP[1])/TEF['Asp'])+2
herringtp.Ala <- (((herring['Ala']-herring['Phe'])-Beta.JN$ALA [1]-TEF.JN$ALA[1])/TEF['Ala'])+2
...
TP.GLU <- ((data$GLU.mean-data$PHE.mean-Beta.JN$GLU[1]-TEF.JN$GLU[1])/TEF['Glu'])+2
plot(TP.GLU, ylim = c(0,6))
mean(na.omit(TP.GLU))

TP.ALA <- (((data$ALA.mean-data$PHE.mean)-Beta.JN$ALA[1]-TEF.JN$ALA[1])/TEF['Ala'])+2
mean(na.omit(TP.ALA))

#TP.ILE <- (((data$GLU.mean-data$PHE.mean)-Beta.JN$ILE-TEF$Glu)/6.6)+2
#plot(TP.GLU, ylim = c(0,6))

TP.PRO <- (((data$PRO.mean-data$PHE.mean)-Beta.JN$PRO[1]-TEF.JN$PRO[1])/TEF['Pro'])+2
mean(na.omit(TP.PRO))
...
TP.VAL <- (((data$VAL.mean-data$PHE.mean)-Beta.JN$VAL[1]-TEF.JN$VAL[1])/TEF['Val'])+2
mean(na.omit(TP.VAL))
...
write.csv(total2, 'Data/Compiled/HierarchicalData_4.csv')
