...
offset <- 3 #difference between bone collagen to diet
Function.MixingModel <- function(dataframe) {
  
  mixing.output <- ((dataframe[,"Obs"]-offset-dataframe[,"C4EM"])/(dataframe[,"C3EM"]-dataframe[,"C4EM"]))*100
...
Function.MixingModel2 <- Function.MixingModel <- function(dataframe) {
  ...
  mixing.output <- ((dataframe[,"Obs"]-offset-dataframe[,"C3EM"])/(dataframe[,"C4EM"]-dataframe[,"C3EM"]))*100
...
colnames(TP)<- c("TP.ALA1", "TP.GLU1", "TP.VAL1", "TP.PRO1","TP.ASP1",
                 "TP.ALA1.beta", "TP.GLU1.beta", "TP.VAL1.beta", "TP.PRO1.beta","TP.ASP1.beta",
                   "TP.ALA2", "TP.GLU2", "TP.VAL2", "TP.PRO2","TP.ASP2",
                 "TP.ALA2.beta", "TP.GLU2.beta", "TP.VAL2.beta", "TP.PRO2.beta","TP.ASP2.beta",
                   "TP.ALA3", "TP.GLU3", "TP.VAL3", "TP.PRO3","TP.ASP3",
                 "TP.ALA3.beta", "TP.GLU3.beta", "TP.VAL3.beta", "TP.PRO3.beta","TP.ASP3.beta",
                   "TP.ALA4", "TP.GLU4", "TP.VAL4", "TP.PRO4", "TP.ASP4",
                 "TP.ALA4.beta", "TP.GLU4.beta", "TP.VAL4.beta","TP.PRO4.beta", "TP.ASP4.beta")
...
cex=0.85
pdf(file="Results/Figures/TEF.Corr.pdf", width=5, height=5)
...
par(xpd=FALSE)
sum(na.omit(TP[,1:5]) > 3.5 & na.omit(TP[,1:5]) < 5)/sum(na.omit(TP[,1:5]) > 0 & na.omit(TP[,1:5]) < 8)#0.15
sum(na.omit(TP[,1:4]) > 3.5 & na.omit(TP[,1:4]) < 5)/sum(na.omit(TP[,1:4]) > 0 & na.omit(TP[,1:4]) < 8)#0.18
...
sum(na.omit(TP[,11:15]) > 3.5 & na.omit(TP[,11:15]) < 5)/sum(na.omit(TP[,11:15]) > 0 & na.omit(TP[,11:15]) < 8)#0.21
sum(na.omit(TP[,11:14]) > 3.5 & na.omit(TP[,11:14]) < 5)/sum(na.omit(TP[,11:14]) > 0 & na.omit(TP[,11:14]) < 8)#0.20
...
polygon(x=c(3.5,5,5,3.5), y=c(0,0,2,2), col=alpha('grey',0.15), border='grey')
sum(na.omit(TP[,21:25]) > 3.5 & na.omit(TP[,21:25]) < 5)/sum(na.omit(TP[,21:25]) > 0 & na.omit(TP[,21:25]) < 8)#0.66
sum(na.omit(TP[,21:24]) > 3.5 & na.omit(TP[,21:24]) < 5)/sum(na.omit(TP[,21:24]) > 0 & na.omit(TP[,21:24]) < 8)#0.65
...
polygon(x=c(3.5,5,5,3.5), y=c(0,0,2,2), col=alpha('grey',0.15), border='grey')
sum(na.omit(TP[,31:35]) > 3.5 & na.omit(TP[,31:35]) < 5)/sum(na.omit(TP[,31:35]) > 0 & na.omit(TP[,31:35]) < 8)#0.28
sum(na.omit(TP[,31:34]) > 3.5 & na.omit(TP[,31:34]) < 5)/sum(na.omit(TP[,31:34]) > 0 & na.omit(TP[,31:34]) < 8)#0.16
...
pdf(file="Results/Figures/TEF.beta.Corr.pdf", width=5, height=5)
par(mfrow=c(2,2),mar=c(4,3,4,2))
...
legend(4.85, 2,legend=c("Alanine", "Glutamic Acid", "Valine", "Aspartic Acid", "Proline","Ecologically", "Realistic"),
       col=c('#7EBA68', '#CCA65A','#00C1B2', "#6FB1E7",'#D494E1',"grey",""),lty=c(3,1,2,4,5,1,0),  cex=0.7, bty='n')
par(xpd=FALSE)
sum(na.omit(TP[,6:10]) > 3.5 & na.omit(TP[,6:10]) < 5)/sum(na.omit(TP[,6:10]) > 0 & na.omit(TP[,6:10]) < 8) #0.46
sum(na.omit(TP[,6:9]) > 3.5 & na.omit(TP[,6:9]) < 5)/sum(na.omit(TP[,6:9]) > 0 & na.omit(TP[,6:9]) < 8) #0.48
text(4.25,1.85,labels="0.47",cex=cex)
...
polygon(x=c(3.5,5,5,3.5), y=c(0,0,2,2), col=alpha('grey',0.15), border='grey')
sum(na.omit(TP[,16:20]) > 3.5 & na.omit(TP[,16:20]) < 5)/sum(na.omit(TP[,16:20]) > 0 & na.omit(TP[,16:20]) < 8)#0.61
sum(na.omit(TP[,16:19]) > 3.5 & na.omit(TP[,16:19]) < 5)/sum(na.omit(TP[,16:19]) > 0 & na.omit(TP[,16:19]) < 8)#0.60
...
polygon(x=c(3.5,5,5,3.5), y=c(0,0,2,2), col=alpha('grey',0.15), border='grey')
sum(na.omit(TP[,26:30]) > 3.5 & na.omit(TP[,26:30]) < 5)/sum(na.omit(TP[,26:30]) > 0 & na.omit(TP[,26:30]) < 8)#0.72
sum(na.omit(TP[,26:29]) > 3.5 & na.omit(TP[,26:29]) < 5)/sum(na.omit(TP[,26:29]) > 0 & na.omit(TP[,26:29]) < 8)#0.71
text(4.25,1.85,labels="0.72",cex=cex)
...
polygon(x=c(3.5,5,5,3.5), y=c(0,0,2,2), col=alpha('grey',0.15), border='grey')
sum(na.omit(TP[,36:40]) > 3.5 & na.omit(TP[,36:40]) < 5)/sum(na.omit(TP[,36:40]) > 0 & na.omit(TP[,36:40]) < 8)#0.64
sum(na.omit(TP[,36:39]) > 3.5 & na.omit(TP[,36:39]) < 5)/sum(na.omit(TP[,36:39]) > 0 & na.omit(TP[,36:39]) < 8)#0.63
...
write.csv(total2, 'Data/Compiled/HierarchicalDataCorr.csv')
...
write.csv(total2, 'Data/Compiled/HierarchicalData2Corr.csv')
...
write.csv(total2, 'Data/Compiled/HierarchicalData3Corr.csv')
...
write.csv(total2, 'Data/Compiled/HierarchicalData4Corr.csv')
...
write.csv(total2, 'Data/Compiled/HierarchicalData5Corr.csv')
